...
var provider = function () {
    ...
    return function (Wrapped) {
        ...
        return hoistNonReactStatics__default["default"](Provider, Wrapped);
    };
};
/**
...
function useInstance(token) {
    ...
    var _b = react.useState({}), updater = _b[1];
    var refUpd = react.useRef({ updater: updater });
...
var ComponentWithServices = function (_a) {
    ...
    var ref = react.useRef(provider.apply(void 0, services)(ComponentWithService));
    return react.createElement(ref.current, null, children);
};

exports.ComponentWithServices = ComponentWithServices;
exports.Inject = inject;
exports.InjectedService = InjectedService;
exports.LiteEventImpl = LiteEventImpl;
