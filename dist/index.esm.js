	...
	return function(Wrapped) {
		...
		var Provider = /** @class */ (function(_super) {
			...
			Provider.prototype.render = function() {
				return createElement(InjectorContext.Provider, { value: { injector: this } }, createElement(Wrapped, this.props));
			};
			/**
...
var MutationProvider = /** @class */ (function() {
	...
	MutationProvider.prototype.start = function(inc) {
		...
		if (this.count == 0) {
			var draft_1 = (this.draft = (_a = this.draft) !== null && _a !== void 0 ? _a : createDraft(this.service));
		...
		if (this.count == 0) {
			...
			if (this.count == 0) {
				...
				if (draft_2) {
					...
					var newstate_1 = finishDraft(draft_2);
					this.service[STORES].forEach(function(x) {
